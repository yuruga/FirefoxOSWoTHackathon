...
var CONFIG = require('./ble/Config').CONFIG;
var BleService = require('./ble/BleService').BleService;
...
var CSC = (function () {
  ...
  CSC.prototype.onReadDescriptor = function (value) {
...
window.csc = new CSC();
},{"./ble/BleService":3,"./ble/Config":4,"./sync/SyncService":5}],2:[function(require,module,exports){
"use strict";
...
var BleService = (function () {
  ...
  BleService.prototype.stopScanServices = function () {
    this.scanService = false;
  };

  BleService.prototype.stopScanCharacteristic = function () {
  ...
  BleService.prototype.selectCharacteristic = function (charId) {
  ...
  BleService.prototype.writeDescriptor = function (value, length) {
    //this.select_descr_id = descriptorId;
    ...
    if (event.status == 0) {
      ...
      if (!this.rssi_timer) {
        this.rssi_timer = setInterval(function () {
          _this5.bleManager.readRemoteRssi(_this5.client_if, _this5.bd_addr);
        }, 5000);
      }
  ...
  BleService.prototype._onGetDescriptor = function (event) {
